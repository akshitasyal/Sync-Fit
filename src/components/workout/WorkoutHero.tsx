...
export default function WorkoutHero({
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-[32px] p-6 sm:p-8 md:p-10 shadow-sm relative overflow-hidden space-y-8">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="space-y-2">
            <div className="flex items-center gap-2.5 flex-wrap">
              ...
              {day.isCompleted && (
                <span className="text-xs font-black text-[#111111] bg-[#c1ff00] px-3 py-1 rounded-full flex items-center gap-1 shadow-sm">
            ...
            {!isRest && (
              <div className="flex items-center gap-3 text-xs sm:text-sm text-gray-500 font-semibold pt-1 flex-wrap">
          ...
          {!isRest && onStartWorkout && (
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 bg-[#c1ff00] hover:bg-[#aadf00] text-black font-black rounded-2xl transition-all hover:scale-105 shadow-[0_4px_20px_rgba(193,255,0,0.4)] flex items-center justify-center gap-3 group text-sm sm:text-base"
            >
