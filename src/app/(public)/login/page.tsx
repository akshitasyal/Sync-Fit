  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-10 sm:py-12 px-3.5 sm:px-6 lg:px-8 bg-[#020617] relative overflow-hidden font-sans">
      ...
      >
        ...
        <form className="mt-6 sm:mt-10 space-y-5 sm:space-y-6" onSubmit={handleSubmit}>
          <AnimatePresence>
            {error && (
              <motion.div
          ...
          <div className="space-y-4 sm:space-y-5">
            <div className="space-y-1.5">
              <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] ml-3 sm:ml-4" htmlFor="email">
                Email Address
              </label>
              <input
                id="email"
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] ml-3 sm:ml-4" htmlFor="password">
                Password
              </label>
              <input
                id="password"
