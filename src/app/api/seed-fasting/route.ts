...
const fastingMealsToSeed = [
  ...
  { name: "Fruit Bowl with Nuts", imageUrl: "/images/meals/fruit-bowl-with-nuts.jpg", dietType: "vegetarian", category: "breakfast", isFastingMeal: true, type: "maintenance", tags: ["Fasting"], calories: 250, protein: 5, carbs: 45, fat: 8, ingredients: ["Banana", "Apple", "Pomegranate", "Almonds", "Walnuts"], preparationSteps: ["Chop all fruits.", "Mix in bowl.", "Top with almonds and walnuts."] },
  { name: "Sabudana Kheer", imageUrl: "/images/meals/sabudana-kheer.jpg", dietType: "vegetarian", category: "breakfast", isFastingMeal: true, type: "maintenance", tags: ["Fasting"], calories: 320, protein: 6, carbs: 60, fat: 7, ingredients: ["Sabudana (Sago)", "Milk", "Cardamom", "Almonds", "Jaggery"], preparationSteps: ["Soak sabudana 2 hrs.", "Boil milk, add sabudana.", "Add jaggery, cardamom, nuts. Serve warm."] },
  { name: "Makhana Milk with Dates", imageUrl: "/images/meals/makhana-milk-with-dates.jpg", dietType: "vegetarian", category: "breakfast", isFastingMeal: true, type: "maintenance", tags: ["Fasting"], calories: 280, protein: 8, carbs: 40, fat: 10, ingredients: ["Makhana (Foxnuts)", "Milk", "Dates", "Saffron"], preparationSteps: ["Lightly roast makhana.", "Boil milk with dates and saffron.", "Add makhana, simmer 5 min."] },
  { name: "Dry Fruits Mix and Apple", imageUrl: "/images/meals/dry-fruits-mix-and-apple.jpg", dietType: "vegetarian", category: "breakfast", isFastingMeal: true, type: "cutting", tags: ["Fasting"], calories: 220, protein: 4, carbs: 35, fat: 8, ingredients: ["Apple", "Cashews", "Raisins", "Pistachios"], preparationSteps: ["Slice the apple.", "Serve alongside a mix of dry fruits."] },
  { name: "Sabudana Khichdi Vrat Special", imageUrl: "/images/meals/sabudana-khichdi-vrat-special.jpg", dietType: "vegetarian", category: "breakfast", isFastingMeal: true, type: "maintenance", tags: ["Fasting", "Gluten-Free"], calories: 320, protein: 5, carbs: 64, fat: 8, ingredients: ["Sabudana", "Peanuts", "Green Chilies", "Cumin", "Ghee"], preparationSteps: ["Soak sabudana.", "Sauté cumin + chilies in ghee.", "Add peanuts + sabudana. Cook until translucent."] },
  ...
  { name: "Lauki Bottle Gourd Sabzi Vegan", imageUrl: "/images/meals/lauki-bottle-gourd-sabzi-vegan.jpg", dietType: "vegan", category: "dinner", isFastingMeal: true, type: "cutting", tags: ["Fasting", "Low-Carb"], calories: 150, protein: 3, carbs: 25, fat: 5, ingredients: ["Bottle Gourd", "Tomato", "Cumin", "Rock Salt", "Coconut Oil"], preparationSteps: ["Dice lauki.", "Sauté with tomato and cumin in coconut oil.", "Pressure cook until soft."] },
  { name: "Vegan Makhana Coconut Soup", imageUrl: "/images/meals/vegan-makhana-coconut-soup.jpg", dietType: "vegan", category: "dinner", isFastingMeal: true, type: "cutting", tags: ["Fasting", "Low-Carb"], calories: 180, protein: 5, carbs: 22, fat: 8, ingredients: ["Makhana (Foxnuts)", "Coconut Milk", "Ginger", "Rock Salt", "Black Pepper"], preparationSteps: ["Roast makhana lightly.", "Blend coconut milk with ginger.", "Simmer makhana in coconut broth."] },
  // Snacks
  { name: "Roasted Masala Makhana Vrat", imageUrl: "/images/meals/roasted-masala-makhana-vrat.jpg", dietType: "vegetarian", category: "snack", isFastingMeal: true, type: "cutting", tags: ["Fasting", "Low-Carb"], calories: 180, protein: 6, carbs: 20, fat: 8, ingredients: ["Fox Nuts (Makhana)", "Ghee", "Rock Salt", "Black Pepper"], preparationSteps: ["Dry roast makhana in ghee.", "Toss with spices."] },
  { name: "Mixed Fruit Bowl Fasting", imageUrl: "/images/meals/mixed-fruit-bowl-fasting.jpg", dietType: "vegan", category: "snack", isFastingMeal: true, type: "cutting", tags: ["Fasting"], calories: 120, protein: 1, carbs: 30, fat: 0, ingredients: ["Banana", "Apple", "Grapes", "Pomegranate"], preparationSteps: ["Dice all fruits and serve fresh."] },
  ...
  { name: "Sweet Potato Chaat Snack", imageUrl: "/images/meals/sweet-potato-chaat-snack.jpg", dietType: "vegan", category: "snack", isFastingMeal: true, type: "cutting", tags: ["Fasting"], calories: 190, protein: 4, carbs: 42, fat: 1, ingredients: ["Sweet Potato", "Rock Salt", "Cumin", "Lemon Juice", "Coriander"], preparationSteps: ["Boil and dice.", "Toss with lemon and rock salt."] },
  { name: "Almonds and Walnuts Mix", imageUrl: "/images/meals/almonds-and-walnuts-mix.jpg", dietType: "vegan", category: "snack", isFastingMeal: true, type: "maintenance", tags: ["Fasting", "Keto"], calories: 210, protein: 6, carbs: 8, fat: 18, ingredients: ["Almonds", "Walnuts"], preparationSteps: ["Serve raw or soaked overnight."] },
  { name: "Vrat Peanut Chikki", imageUrl: "/images/meals/vrat-peanut-chikki.jpg", dietType: "vegetarian", category: "snack", isFastingMeal: true, type: "bulking", tags: ["Fasting", "High-Protein"], calories: 265, protein: 8, carbs: 30, fat: 13, ingredients: ["Peanuts", "Jaggery", "Rock Salt", "Ghee"], preparationSteps: ["Roast peanuts.", "Melt jaggery with ghee.", "Mix and press into slabs, cut when cooled."] },
  { name: "Dry Fig and Almond Trail Mix", imageUrl: "/images/meals/dry-fig-and-almond-trail-mix.jpg", dietType: "vegan", category: "snack", isFastingMeal: true, type: "maintenance", tags: ["Fasting"], calories: 220, protein: 5, carbs: 28, fat: 11, ingredients: ["Dried Figs", "Almonds", "Cashews", "Pumpkin Seeds"], preparationSteps: ["Mix all ingredients.", "Serve in portion bowls."] },
];
