...
export async function POST(req: Request) {
  try {
    ...
    const { age, height, weight, energyLevel, sleepQuality, goal, dietPreference, experienceLevel } = data;
    ...
    const updatedUser = await User.findOneAndUpdate(
      { email: userEmail },
      {
        age, height, weight, energyLevel, sleepQuality, goal, dietPreference, experienceLevel,
        recommendations: {
