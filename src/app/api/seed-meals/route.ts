...
const vegetarianMeals = [
  ...
  { name: "Besan Chilla", dietType: "vegetarian", category: "breakfast", calories: 310, protein: 18, carbs: 35, fat: 10, tags: ["High-Protein", "Low-Carb"], type: "maintenance", ingredients: ["Chickpea Flour", "Spinach", "Tomatoes", "Onion", "Ghee"], preparationSteps: ["Mix flour with water & veg.", "Cook on tawa with ghee.", "Fold and serve."] },
  ...
  { name: "Paneer Bhurji with Paratha", dietType: "vegetarian", category: "breakfast", calories: 440, protein: 22, carbs: 44, fat: 18, tags: ["High-Protein", "Balanced Diet"], type: "bulking", ingredients: ["Paneer", "Onion", "Tomato", "Spices", "Whole Wheat Paratha", "Ghee"], preparationSteps: ["Scramble paneer with onion, tomato, spices.", "Serve with hot paratha."] },
  ...
  { name: "Vegetarian Peanut Noodles", dietType: "vegetarian", category: "dinner", calories: 450, protein: 16, carbs: 66, fat: 14, tags: ["Balanced Diet"], type: "maintenance", ingredients: ["Rice Noodles", "Tofu", "Peanuts", "Bean Sprouts", "Tamarind Sauce"], preparationSteps: ["Stir-fry noodles with sauce.", "Add crispy tofu.", "Mix in sprouts and peanuts."] },
  ...
  { name: "Eggless Banana Oat Pancakes", dietType: "vegetarian", category: "breakfast", calories: 380, protein: 10, carbs: 62, fat: 12, tags: ["Balanced Diet"], type: "bulking", ingredients: ["Banana", "Rolled Oats", "Milk", "Honey", "Butter"], preparationSteps: ["Blend oats, milk, banana.", "Cook small pancakes in butter.", "Drizzle honey."] },
  { name: "Moong Dal Cheela", dietType: "vegetarian", category: "breakfast", calories: 280, protein: 16, carbs: 38, fat: 8, tags: ["High-Protein", "Balanced Diet"], type: "cutting", ingredients: ["Yellow Lentils", "Onion", "Coriander", "Spices", "Ghee"], preparationSteps: ["Blend soaked lentils.", "Cook thin crepes.", "Serve with chutney."] },
  ...
  { name: "Paneer Cubes with Mint Chutney", dietType: "vegetarian", category: "snack", calories: 200, protein: 16, carbs: 4, fat: 14, tags: ["High-Protein", "Keto"], type: "cutting", ingredients: ["Paneer", "Mint", "Coriander", "Green Chilies", "Lemon"], preparationSteps: ["Cut paneer into cubes.", "Blend chutney ingredients.", "Serve together."] },
];
