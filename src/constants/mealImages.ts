...
export const MEAL_IMAGE_REGISTRY: Record<string, MealImageMeta> = {
  ...
  "egg & veggie omelette": {
    imageUrl: "/images/meals/egg-veggie-omelette.jpg",
    prepTimeMinutes: 12,
    tags: ["non-vegetarian"],
  },
  "chicken tikka": {
  ...
  "coconut water & banana bowl": {
    imageUrl: "/images/meals/coconut-water-banana-bowl.jpg",
    prepTimeMinutes: 12,
    tags: ["vegan"],
  },
  ...
  "mango & chia parfait": {
    imageUrl: "/images/meals/mango-chia-parfait.jpg",
    prepTimeMinutes: 12,
    tags: ["vegan"],
  },
  ...
  "oatmeal with banana & walnuts": {
    imageUrl: "/images/meals/oatmeal-with-banana-walnuts.jpg",
    prepTimeMinutes: 12,
    tags: ["vegan"],
  },
  "papaya & apple bowl": {
    imageUrl: "/images/meals/papaya-apple-bowl.jpg",
    prepTimeMinutes: 12,
    tags: ["vegan"],
  },
  ...
  "mujaddara (lentil & rice)": {
    imageUrl: "/images/meals/mujaddara-lentil-rice.jpg",
    prepTimeMinutes: 25,
    tags: ["vegan"],
  },
  "sweet potato & black bean enchiladas": {
    imageUrl: "/images/meals/sweet-potato-black-bean-enchiladas.jpg",
    prepTimeMinutes: 25,
    tags: ["vegan"],
  },
  "vegan buddha bowl": {
  ...
  "quinoa & black bean salad": {
    imageUrl: "/images/meals/quinoa-black-bean-salad.jpg",
    prepTimeMinutes: 25,
    tags: ["vegan"],
  },
  "rajma chawal": {
  ...
  "sweet potato & peanut curry": {
    imageUrl: "/images/meals/sweet-potato-peanut-curry.jpg",
    prepTimeMinutes: 25,
    tags: ["vegan"],
  },
  ...
  "dry fig & almond trail mix": {
    imageUrl: "/images/meals/dry-fig-almond-trail-mix.jpg",
    prepTimeMinutes: 5,
    tags: ["vegan"],
  },
  ...
  "handful of almonds & walnuts": {
    imageUrl: "/images/meals/handful-of-almonds-walnuts.jpg",
    prepTimeMinutes: 5,
    tags: ["vegan"],
  },
  ...
  "peanut butter & apple": {
    imageUrl: "/images/meals/peanut-butter-apple.jpg",
    prepTimeMinutes: 5,
    tags: ["vegan"],
  },
  "roasted chickpeas": {
  ...
  "banana & almond milk smoothie": {
    imageUrl: "/images/meals/banana-almond-milk-smoothie.jpg",
    prepTimeMinutes: 12,
    tags: ["vegetarian"],
  },
  "besan chilla": {
  ...
  "greek yogurt with honey & walnuts": {
    imageUrl: "/images/meals/greek-yogurt-with-honey-walnuts.jpg",
    prepTimeMinutes: 12,
    tags: ["vegetarian"],
  },
  "idli sambar": {
  ...
  "paneer & tomato sabzi (vrat)": {
    imageUrl: "/images/meals/paneer-tomato-sabzi-vrat.jpg",
    prepTimeMinutes: 25,
    tags: ["vegetarian"],
  },
  "paneer tikka": {
  ...
  "vrat ke aloo & curd": {
    imageUrl: "/images/meals/vrat-ke-aloo-curd.jpg",
    prepTimeMinutes: 25,
    tags: ["vegetarian"],
  },
  "cheese & vegetable quesadilla": {
    imageUrl: "/images/meals/cheese-vegetable-quesadilla.jpg",
    prepTimeMinutes: 5,
    tags: ["vegetarian"],
  },
  "fruit & nut yogurt bowl": {
    imageUrl: "/images/meals/fruit-nut-yogurt-bowl.jpg",
    prepTimeMinutes: 5,
    tags: ["vegetarian"],
  },
